...
export const dict = {
  ru: {
    ...
    landing: {
      ...
      editorStep1Title: 'Оставляете заявку',
      editorStep2Title: 'Проходите модерацию',
      editorStep3Title: 'Берёте треки из ленты',
  ...
  en: {
    ...
    landing: {
      ...
      editorStep1Title: 'Submit an application',
      editorStep2Title: 'Pass moderation',
      editorStep3Title: 'Take tracks from the feed',
