  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="skeleton h-9 w-56 rounded-none" />
          <div className="skeleton mt-3 h-4 w-72 rounded-none" />
        </div>
      ...
      <div className="mt-10 flex flex-col gap-4">
        {[0, 1, 2].map((i) => (
          <div key={i} className="rounded-none border border-border bg-surface p-6">
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="skeleton h-6 w-1/2 rounded-none" />
                <div className="skeleton mt-2 h-4 w-full rounded-none" />
