// Ночной визуал хиро: график просмотров (зелёный) слева перетекает в блоки
// зарезервированных слотов (синий) справа — просмотры превращаются в
// закреплённые за клиппером задания. Никаких хроматических градиентов — два
// сплошных цвета + плоский синий vignette. Плавная анимация «дыхания» —
// чистый CSS (см. globals.css, .hero-wave__*), у каждого штриха свой сдвиг
// фазы, поэтому идёт медленная бегущая волна. Всё гаснет при
// prefers-reduced-motion. Серверный компонент, детерминированная форма.
const BARS = [
